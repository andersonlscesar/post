...
export function formSwitch() {
    const linkCadElement = <HTMLAnchorElement> document.querySelector('a[data-js="cad--link"]')
    const linkLoginElement = <HTMLAnchorElement> document.querySelector('a[data-js="login--link"]')
